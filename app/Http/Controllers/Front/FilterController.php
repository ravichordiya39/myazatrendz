...
class FilterController extends Controller
{
    ...
    public function index(Request $request, $dcat) {
        ...
        return view('store.search', compact('products','categories','categoryfilter','colors','colorfilter','sizes','sizefilter','attributes','attributefilter','catid','allcategories','categorysearch','catbanner'));
    }
    ...
    //   $data = $products->orderBy('products.id','desc')->groupBy('products.id')->toSql();
