  ...
  <div class="card-header">
    ...
    <div class="card-body">
        <form method="POST" class="form-row" action="{{ route("admin.cms-pages.update", [$cmsPage->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group col-6">
                <label for="description">{{ trans('cruds.cmsPage.fields.description') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $cmsPage->description) !!}</textarea>
