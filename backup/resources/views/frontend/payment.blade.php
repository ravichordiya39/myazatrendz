            ...
            <div role="tabpanel" class="tab-pane active" id="creditcard">
              <div class="col-md-12 ">
                      ...
                      <div class="form-group">
                        ...
                        <img src="{{asset('frontend/images/payment-mode-img.jpg')}}" alt="" class="payment-img" />
            ...
            <div role="tabpanel" class="tab-pane" id="netbanking">
              ...
              <div class="col-lg-12 col-md-12">
                  <ul class="netbanking-list">
                    <li><a href="#"><img src="{{asset('frontend/images/bank-logo/axis-logo.jpg')}}" alt=""><br>Axis</a></li>
                    <li><a href="#"><img src="{{asset('frontend/images/bank-logo/hdfc-logo.jpg')}}" alt=""><br>HDFC</a></li>
                    <li><a href="#"><img src="{{asset('frontend/images/bank-logo/icci-logo.jpg')}}" alt=""><br>ICCI</a></li>
                    <li><a href="#"><img src="{{asset('frontend/images/bank-logo/sbi-logo.jpg')}}" alt=""><br>SBI</a></li>
                    <li><a href="#"><img src="{{asset('frontend/images/bank-logo/kotak-logo.jpg')}}" alt=""><br>Kotak</a></li>
                    <li><a href="#"><img src="{{asset('frontend/images/bank-logo/citi-bank-logo.jpg')}}" alt=""><br>Citi</a></li>
                    <li><a href="#"><img src="{{asset('frontend/images/bank-logo/rbl-bank-logo.jpg')}}" alt=""><br>RBL</a></li>
                    <li><a href="#"><img src="{{asset('frontend/images/bank-logo/bank-of-baroda-logo.jpg')}}" alt=""><br>Bank of Baroda</a></li>
                ...
                <li>Subtotal <span><i class="fas fa-rupee-sign"></i> 2000</span></li>
                 <li>Coupon Discount <span class="txtorange boldtxt">Apply Coupon</span></li>
                  <li>Delivery Charges  <span class="txtorange">Free</span></li>
                   ...
                   <li><div style="display:inline-block; width:auto; margin-right:10px;">We Accept</div><div style="display:inline-block; width:auto;"><img src="{{asset('frontend/images/payment_method.png')}}" alt="" width="230"  /></div></li>
              </ul>
            </div>
          </div>
          </div>
                ...
                <div class="col-lg-3 col-md-6 char_col">
                  <div class="char_item d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="char_content">
                      <div class="char_title">100% Authorised<br> product</div>
                    </div>
                  </div>
                </div>
