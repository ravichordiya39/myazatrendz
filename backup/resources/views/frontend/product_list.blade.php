        ...
        <div class="item">
            <div class="product-card">
                ...
                <div class="text-caption">
                    ...
                    <p>
                        <span class="price-txt">Rs.{{$product['single_sales_price']}}</span> <span class="price-oveline">Rs.{{$product['single_mrp_price']}}</span> <span class="discount-text">
                ...
                <div class="icon-wishlist">
                    <button type="button"  data-toggle="tooltip" data-placement="left" title="Save for Later">
